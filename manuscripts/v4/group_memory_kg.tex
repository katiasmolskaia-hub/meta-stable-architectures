...
If needed, the forgetting rate can itself be made state-dependent, so that the memory stays labile: small when the memory is fresh, and larger when $K_g$ approaches saturation. This keeps $K_g$ bounded without turning it into a permanent booster.
