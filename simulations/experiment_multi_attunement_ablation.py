...
def main() -> None:
    ...
    variants = {
        "scalar_attunement": {"attunement_mode": "scalar"},
        "multi_attunement": {"attunement_mode": "multi"},
    }
    ...
    for variant, extra in variants.items():
        ...
        for idx, lesson in enumerate(lessons, 1):
            ...
            print(
                ...
                f"final_att={row['final_attunement']:.3f}"
            )

    csv_path = out_dir / "multi_attunement_ablation.csv"
    ...
    axes[3].set_ylabel("final attunement")
    axes[3].set_xlabel("lesson")
    axes[0].set_title("Scalar vs multi-channel attunement")
    ...
    fig.tight_layout()
    plot_path = out_dir / "multi_attunement_ablation_plot.png"
