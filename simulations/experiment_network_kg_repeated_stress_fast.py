...
def main() -> None:
    ...
    for row in summaries:
        print(
            ...
            f"ep1={row['episode1_rt']:.3f}, ep2={row['episode2_rt']:.3f}, ep3={row['episode3_rt']:.3f}, ep4={row['episode4_rt']:.3f}, "
            f"final_kg={row['final_group_memory']:.3f}, mean_phi={row['mean_phi_gain']:.3f}"
        )

    csv_path = out_dir / "network_kg_repeated_stress_fast_summary.csv"
    ...
    try:
        ...
        fig.tight_layout()
        plot_path = out_dir / "network_kg_repeated_stress_fast_plot.png"
